...
<body>
 ...
 if(isset($_REQUEST["pid"]))
 {
     ...
     $link=$con->db_connect();
     $pid=$_REQUEST["pid"];
     $qry="select * from tbprd where prdcod=$pid";
 ...
 ?>
      <div class="product-box">
        <table>
            <tr>
                <td><div class="prodt-img"><img src="prdimg/<?php echo$r[3]; ?>" height="150px" width="150px" /></div></td>
                <td>       <h4> <?php //echo $arr[$i][1]; ?> </h4>
             <td><h1><?php echo" $r[1] ";?><br></h1>
                 <h2> <?php echo" $r[2] <br>";?><br>
                   PRICE:RS<?php echo"$r[4]<br>"; ?></h2>
                <h2>    <a class="add-cart" href="frmcrt.php?pid=<?php echo $r[0]; ?>&action=add">Add To Cart</a></h2>
