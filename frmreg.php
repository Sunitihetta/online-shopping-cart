...
<body>
    ...
    <div id="wrapper">
        ...
        <!-- ****** Popular Brands Area Start ****** -->
            <div class="container">
                <div class="row">
        <form method="post"  action="frmreg.php" onsubmit="return validate_register();" style="display: grid; align-content: center; margin: 0 auto; width:500px !important;">
          <table>
              <tr>
              ...
              <tr>
                  ...
                  <td><input type="password" name="txtconpwd" id="txtconpwd" class="form-control"/></td>
              </tr>
              <TR>
                  <td colspan="2" style="text-align: center; margin: 0 auto;">
                      <input type="submit" value="REGISTER" name="btnsub" class="form-control"/></br>
                      <a href="frmlogin.php">ALREADY REGISTER..LOGIN HERE</a>
                      </br>
                  </td>
              </TR> </table>
      </form>
